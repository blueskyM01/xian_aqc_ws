...
class Xian_CameraDriver
{
    public:
        ...
        void init()
        {
            video_0.open("/root/code/test_meterials/cell_guide_simulator/tl.mp4"); 
            video_1.open("/root/code/test_meterials/cell_guide_simulator/tr.mp4");  
            video_2.open("/root/code/test_meterials/cell_guide_simulator/bl.mp4"); 
            video_3.open("/root/code/test_meterials/cell_guide_simulator/br.mp4"); 
            video_0 >> tl_image;
            video_1 >> tr_image;
            video_2 >> bl_image;
            video_3 >> br_image;
